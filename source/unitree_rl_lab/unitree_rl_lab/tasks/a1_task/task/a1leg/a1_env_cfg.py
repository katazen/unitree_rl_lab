...
from unitree_rl_lab.assets.A1_legs_V1.a1leg import A1leg_CFG as ROBOT_CFG
from unitree_rl_lab.tasks.a1_task import mdp
...
class RewardsCfg:
    ...
    base_angular = RewTerm(func=mdp.ang_vel_xy_l2, weight=-0.2)
    ...
    base_height = RewTerm(func=mdp.base_height_l2, weight=-10, params={"target_height": 0.55})
