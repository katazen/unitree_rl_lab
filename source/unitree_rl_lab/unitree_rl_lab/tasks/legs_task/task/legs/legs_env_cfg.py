...
from unitree_rl_lab.assets.legs_URDF.legs import LEGS_CFG as ROBOT_CFG
from unitree_rl_lab.tasks.legs_task import mdp
...
class RewardsCfg:
    ...
    base_height = RewTerm(func=mdp.base_height_l2, weight=-5, params={"target_height": 0.45})
