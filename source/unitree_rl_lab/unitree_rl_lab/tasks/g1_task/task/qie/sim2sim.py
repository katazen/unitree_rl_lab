...
class SimToSimCfg:
    class path:
        ...
        model_path = '/home/woan/workspace/unitree_rl_lab/logs/rsl_rl/g1qie/2026-05-25_10-12-39/exported/policy.pt'
    ...
    class robot:
        ...
        damping = np.array([2., 2, 2, 4, 2, 2,
                            ...
                            1,1,1, 1, 1,])
        action_scale = 0.25
        cmd_range = [[-0.3, 0.5], [-0.3, 0.3], [-0.3, 0.3]]
...
class MujocoRunner:
    ...
    def get_obs(self):
        ...
        # Angular vel
        obs[0:3] = self.data.sensor("imu-pelvis-angular-velocity").data.astype(np.double) * 0.2
        # Projected gravity
